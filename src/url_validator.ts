...
export class HttpsValidate implements UrlValidateStrategy {
  validate(url: string): boolean {
...
export class HttpValidate implements UrlValidateStrategy {
  validate(url: string): boolean {
    let regExp = new RegExp(
...
export class RFC3986Validate implements UrlValidateStrategy {
  validate(url: string): boolean {
    let regExp = new RegExp(
...
export class UrlValidater {
  ...
  constructor(
    readonly url: string,
    readonly urlValidateStrategy: UrlValidateStrategy = new HttpsValidate(),
  ) {
    this.value = url;
